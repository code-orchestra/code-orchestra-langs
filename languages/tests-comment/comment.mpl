...
<language namespace="codeOrchestra.actionScript.tests.comment" uuid="f99ec8e4-700c-42e7-970b-e330ba8f8c2e" compileInMPS="true" doNotGenerateAdapters="false" engageOnImport="false">
  <models>
    <modelRoot path="${language_descriptor}/languageModels" namespacePrefix="codeOrchestra.actionScript.tests.comment" />
  </models>
  <accessoryModels />
  <generators />
  <sourcePath />
