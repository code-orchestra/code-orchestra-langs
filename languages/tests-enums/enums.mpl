...
<language namespace="codeOrchestra.actionScript.tests.enums" uuid="9732a614-e105-4185-9ce5-05d28c20bfca" java-stubs-enabled="false" compileInMPS="true" doNotGenerateAdapters="false">
  <models>
    <modelRoot path="${language_descriptor}/languageModels" namespacePrefix="codeOrchestra.actionScript.tests.enums" />
  </models>
  <accessoryModels />
  <generators />
  <sourcePath />
