...
<language namespace="codeOrchestra.actionScript.refactoring" uuid="d0050e71-a98b-4d36-acd0-d639954d1958" compileInMPS="true" doNotGenerateAdapters="false" engageOnImport="false">
  <models>
    <modelRoot path="${language_descriptor}/languageModels" namespacePrefix="codeOrchestra.actionScript.refactoring" />
  </models>
  <accessoryModels />
  <generators />
  <sourcePath />
