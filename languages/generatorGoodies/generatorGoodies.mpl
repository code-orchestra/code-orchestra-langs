...
<language namespace="gtext.ext.generatorGoodies" uuid="2e27799e-bab4-4d45-b030-ecb4a8a209be" compileInMPS="true" doNotGenerateAdapters="false" engageOnImport="false">
  <models>
    <modelRoot path="${language_descriptor}/languageModels" namespacePrefix="gtext.ext.generatorGoodies" />
  </models>
  <accessoryModels />
  <generators />
  <sourcePath />
