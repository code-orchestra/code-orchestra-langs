...
<language namespace="codeOrchestra.actionScript.tests.statement" uuid="21f831e6-a6d7-4e08-bcb5-5ac06f0d77af" java-stubs-enabled="false" compileInMPS="true" doNotGenerateAdapters="false">
  <models>
    <modelRoot path="${language_descriptor}/languageModels" namespacePrefix="codeOrchestra.actionScript.tests.statement" />
  </models>
  <accessoryModels />
  <generators />
  <sourcePath />
