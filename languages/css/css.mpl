...
<language namespace="codeOrchestra.actionScript.css" uuid="f06c7be3-bbc6-40b5-acdc-0b7eeddb68d3" compileInMPS="true" doNotGenerateAdapters="false" engageOnImport="false">
  <models>
    <modelRoot path="${language_descriptor}/languageModels" namespacePrefix="codeOrchestra.actionScript.css" />
  </models>
  <accessoryModels />
  <generators>
    <generator name="gtext" generatorUID="codeOrchestra.actionScript.css#1495059040924624086" uuid="f65e3fc6-da32-46d2-8047-71275a072df1">
      <models>
        <modelRoot path="${language_descriptor}/generator/template" namespacePrefix="codeOrchestra.actionScript.css.generator.template" />
      </models>
      <external-templates />
      <usedLanguages>
