...
<language namespace="codeOrchestra.actionScript.run" uuid="3a13f0df-e84d-4c41-8a18-f1af0bdebe0e" compileInMPS="true" doNotGenerateAdapters="false" engageOnImport="false">
  <models>
    <modelRoot path="${language_descriptor}/languageModels" namespacePrefix="codeOrchestra.actionScript.run" />
  </models>
  <accessoryModels />
  <generators />
  <sourcePath>
